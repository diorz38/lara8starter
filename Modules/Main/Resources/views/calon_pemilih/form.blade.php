...
<input class="form-control" name="no_tps" type="hidden" id="no_tps" value="{{ old('no_tps', optional($calonPemilih)->no_tps) }}" maxlength="11" placeholder="Enter no tps here...">
<div class="row">
    <div class="col-3">
...
<div class="form-selectgroup-boxes row mb-3">
    ...
    <div class="col-lg-6">
        <label class="form-selectgroup-item">
            <input id="syarat_1" name="syarat[]" type="checkbox" value="2" {{ in_array('2', old('syarat', optional($calonPemilih)->syarat) ?: []) ? 'checked' : '' }} class="form-selectgroup-input">
            <span class="form-selectgroup-label d-flex align-items-center p-3">
            <span class="mr-3">
                <span class="form-selectgroup-check"></span>
            </span>
    ...
    <div class="col-lg-6">
        <label class="form-selectgroup-item">
            <input id="syarat_1" name="syarat[]" type="checkbox" value="3" {{ in_array('3', old('syarat', optional($calonPemilih)->syarat) ?: []) ? 'checked' : '' }} class="form-selectgroup-input">
            <span class="form-selectgroup-label d-flex align-items-center p-3">
            <span class="mr-3">
                <span class="form-selectgroup-check"></span>
            </span>
    ...
    <div class="col-lg-6">
        <label class="form-selectgroup-item">
            <input id="syarat_1" name="syarat[]" type="checkbox" value="5" {{ in_array('5', old('syarat', optional($calonPemilih)->syarat) ?: []) ? 'checked' : '' }} class="form-selectgroup-input">
            <span class="form-selectgroup-label d-flex align-items-center p-3">
            <span class="mr-3">
                <span class="form-selectgroup-check"></span>
            </span>
...
<div class="mb-3">
    ...
    <label class="form-check form-switch">
        ...
        <span class="form-check-label">PINDAH TAPI IDENTITAS MASIH DI DESA KONDANGJAYA</span>
    </label>
    <label class="form-check form-switch">
        ...
        <span class="form-check-label">PEMILIH SUDAH TIDAK BERDOMISILI DI DESA KONDANGJAYA</span>
    </label>
    <label class="form-check form-switch">
