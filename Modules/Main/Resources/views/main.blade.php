...
<body class="antialiased">
                ...
                <div class="row row-deck row-cards">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-auto d-flex align-items-center pr-2">
                                                ...
                                                <span>Regular</span>
                                                <span
                                                    class="d-none d-md-inline d-lg-none d-xxl-inline ml-2 text-muted">915MB</span>
                                            </div>
                                            <div class="col-auto d-flex align-items-center px-2">
                                                <span class="legend mr-2 bg-info"></span>
                                                <span>System</span>
                                                <span
                                                    class="d-none d-md-inline d-lg-none d-xxl-inline ml-2 text-muted">415MB</span>
                                            </div>
                                            <div class="col-auto d-flex align-items-center px-2">
                                                <span class="legend mr-2 bg-success"></span>
                                                <span>Shared</span>
                                                <span
                                                    class="d-none d-md-inline d-lg-none d-xxl-inline ml-2 text-muted">201MB</span>
                                            </div>
                                            <div class="col-auto d-flex align-items-center pl-2">
                                                <span class="legend mr-2"></span>
                                                <span>Free</span>
                                                <span
                                                    class="d-none d-md-inline d-lg-none d-xxl-inline ml-2 text-muted">612MB</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div>
                                            <div class="avatar-list avatar-list-stacked">
                                                <span class="avatar avatar-sm avatar-rounded"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Elon+Musk)"></span>
                                                <span class="avatar avatar-sm avatar-rounded">JL</span>
                                                <span class="avatar avatar-sm avatar-rounded"
                                                    style="background-image: url(https://ui-avatars.com/api/?rounded=true&name=Elon+Musk)"></span>
                                                <span class="avatar avatar-sm avatar-rounded"
                                                    style="background-image: url(https://ui-avatars.com/api/?rounded=true&name=Elon+Musk)"></span>
                                                <span class="avatar avatar-sm avatar-rounded"
                                                    style="background-image: url(https://ui-avatars.com/api/?rounded=true&name=Elon+Musk)"></span>
                                    ...
                                    <div class="card-body p-4 py-5 text-center">
                                        ...
                                        <div>
                                            <div class="avatar-list avatar-list-stacked">
                                                ...
                                                <span class="avatar avatar-sm avatar-rounded"
                                                    style="background-image: url(https://ui-avatars.com/api/?rounded=true&name=Korong+Hezo)"></span>
                                                <span class="avatar avatar-sm avatar-rounded"
                                                    style="background-image: url(https://ui-avatars.com/api/?rounded=true&name=Si+Bureuleu)"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="progress card-progress">
                                ...
                                <div class="card">
                                    <div class="card-body p-2 text-center">
                                        <div class="text-right text-green">
                                            <span class="text-green d-inline-flex align-items-center lh-1">
                                                6% <svg xmlns="http://www.w3.org/2000/svg" class="icon ml-1" width="24"
                                    ...
                                    <div class="card-body p-2 text-center">
                                        <div class="text-right text-red">
                                            <span class="text-red d-inline-flex align-items-center lh-1">
                                                -2% <svg xmlns="http://www.w3.org/2000/svg" class="icon ml-1" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="2"
                                                    stroke="currentColor" fill="none" stroke-linecap="round"
                                                    stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <div class="col-sm-4">
                                <div class="card">
                                    <div class="card-body p-2 text-center">
                                        <div class="text-right text-green">
                                            <span class="text-green d-inline-flex align-items-center lh-1">
                                                9% <svg xmlns="http://www.w3.org/2000/svg" class="icon ml-1" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="2"
                                                    stroke="currentColor" fill="none" stroke-linecap="round"
                                                    stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                ...
                                <table class="table card-table table-vcenter">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="w-1">
                                                <span class="avatar avatar-sm"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Jablay+Bohay)"></span>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="w-1">
                                                <span class="avatar avatar-sm"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Maya+Luna)"></span>
                                            </td>
                                            <td class="td-truncate">
                                                <div class="text-truncate">
                                        ...
                                        <tr>
                                            <td class="w-1">
                                                <span class="avatar avatar-sm"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Haji+Lulung)"></span>
                                            </td>
                                            <td class="td-truncate">
                                                <div class="text-truncate">
                                ...
                                <div class="divide-y-4">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Lorry+Mion)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Perren+Keemar)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Geoffry+Flaunders)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Thatcher+Keel)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Dyann+Escala)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Avivah+Mugleston)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                    ...
                    <div class="col-md-4">
                        <div class="row row-cards">
                            <div class="col-12">
                                <div class="card card-sm">
                                    <div class="card-body d-flex align-items-center">
                                        <span class="bg-blue text-white avatar mr-3"><svg
                            ...
                            <div class="col-12">
                                <div class="card card-sm">
                                    <div class="card-body d-flex align-items-center">
                                        <span class="bg-green text-white avatar mr-3"><svg
                                                xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <div class="col-12">
                                <div class="card card-sm">
                                    <div class="card-body d-flex align-items-center">
                                        <span class="bg-yellow text-white avatar mr-3"><svg
                                                xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <div class="col-12">
                                <div class="card card-sm">
                                    <div class="card-body d-flex align-items-center">
                                        <span class="bg-twitter text-white avatar mr-3"><svg
                                                xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <div class="col-12">
                                <div class="card card-sm">
                                    <div class="card-body d-flex align-items-center">
                                        <span class="bg-facebook text-white avatar mr-3"><svg
                                                xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <div class="table-responsive">
                                <table class="table card-table table-vcenter">
                                    ...
                                    <tr>
                                        <td>
                                            /about.html
                                            <a href="#" class="ml-1"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank"
                            style="background-image: url({{asset('tabler/static/sponsor-banner-homepage.svg')}})">
                            ...
                            <div class="table-responsive">
                                <table class="table card-table table-vcenter">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="avatar avatar-sm"
                                                style="background-image: url({{asset('table/static/avatars/003m.jpg')}})"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="w-1 pr-0">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            $().peity && $('#sparkline-52').text("35/100").peity("pie", {
                width: 40,
                height: 40,
                stroke: "#206bc4",
                strokeWidth: 2,
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            $().peity && $('#sparkline-53').text("17, 24, 20, 10, 5, 1, 4, 18, 13").peity("line", {
                width: 64,
                height: 40,
                stroke: "#206bc4",
                strokeWidth: 2,
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            $().peity && $('#sparkline-54').text("13, 11, 19, 22, 12, 7, 14, 3, 21").peity("line", {
                width: 64,
                height: 40,
                stroke: "#206bc4",
                strokeWidth: 2,
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            $().peity && $('#sparkline-55').text("10, 13, 10, 4, 17, 3, 23, 22, 19").peity("line", {
                width: 64,
                height: 40,
                stroke: "#206bc4",
                strokeWidth: 2,
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            $().peity && $('#sparkline-56').text("9, 6, 14, 11, 8, 24, 2, 16, 15").peity("line", {
                width: 64,
                height: 40,
                stroke: "#206bc4",
                strokeWidth: 2,
