<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('pages.form-elements')}}">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{route('users.user.index')}}"> List Users </a>
                    </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('pages.docs')}}">
